...
class App {
  ...
  createMedias(
    ...
    const defaultItems = [
      { image: 'https://picsum.photos/seed/1/800/600', text: 'Cloud' },
      { image: 'https://picsum.photos/seed/2/800/600', text: 'AI' },
      { image: 'https://picsum.photos/seed/3/800/600', text: 'Future' },
      { image: 'https://picsum.photos/seed/4/800/600', text: 'Nexus' }
    ];
